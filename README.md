...
- **Home automation**: Integrate with Home Assistant automations ([guide](docs/home-assistant/README.md))
...
- **Remote printing**: [MQTT integration](docs/mqtt-integration.md), [Home Assistant](docs/home-assistant/README.md), and [Apple Shortcuts](docs/apple-shortcuts.md)
