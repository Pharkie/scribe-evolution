                                                    ...
                                                    int timeoutMs)
{
    ...
    // Content body is optional - header is always generated by actionTypeToString()
    // Only fail if we have a genuine error condition (not empty content)
...
{
    if (!result.success || result.header.length() == 0)
    {
