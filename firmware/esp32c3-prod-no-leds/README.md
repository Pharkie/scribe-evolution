...
- `scribe-esp32c3-prod-no-leds-complete.bin` - Complete firmware as a single file
...
```bash
esptool --port /dev/ttyUSB0 --baud 460800 write-flash 0x0 scribe-esp32c3-prod-no-leds-complete.bin
```
